...
public class ImageServiceImpl implements ImageService {
    ...
    public String getImageUrl(String filename) {
        ...
        return cloudinary.url().transformation(new Transformation<>().width(AppConstants.CLOUD_IMAGE_WIDTH)
                .height(AppConstants.CLOUD_IMAGE_WIDTH).crop(AppConstants.CLOUD_IMAGE_CROP)).generate(filename);
    }
